...
var G__31380 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__31380,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__31380;
}
});
...
var len__4730__auto___31385 = arguments.length;
var i__4731__auto___31386 = (0);
while(true){
if((i__4731__auto___31386 < len__4730__auto___31385)){
args__4736__auto__.push((arguments[i__4731__auto___31386]));

var G__31387 = (i__4731__auto___31386 + (1));
i__4731__auto___31386 = G__31387;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq31382){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31383,G__31384,seq31382__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__31389,map__31389__$1,file,line,column){
return (function (p1__31388_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__31388_SHARP_));
});})(map__31389,map__31389__$1,file,line,column))
...
var temp__5720__auto___31391 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___31391)){
var message_31392 = temp__5720__auto___31391;
cljs.core.println.call(null,message_31392);
} else {
}
...
var temp__5720__auto___31393 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___31393)){
var message_31394 = temp__5720__auto___31393;
cljs.core.println.call(null,message_31394);
} else {
}
...
var output_dir__$1 = (function (){var G__31395 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__31395,"/"].join('');
} else {
return G__31395;
}
})();
...
var G__31397 = exception.stack;
var G__31397__$1 = (((G__31397 == null))?null:clojure.string.split_lines.call(null,G__31397));
var G__31397__$2 = (((G__31397__$1 == null))?null:cljs.core.get.call(null,G__31397__$1,depth));
if((G__31397__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__31397__$2);
}
} else {
...
var vec__31398 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__31398,(0),null);
var column = cljs.core.nth.call(null,vec__31398,(1),null);
var vec__31401 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__31401,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__31401,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__31401,(2),null);
...
var m__$1 = (function (){var G__31404 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__31408 = (function (){var G__31407 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__31407);
} else {
return G__31407;
}
})();
...
return cljs.core.vary_meta.call(null,G__31409,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__31413 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__31413,(0),null);
var types = vec__31413;
...
return cljs.core.map.call(null,(function (p__31416){
var vec__31417 = p__31416;
var ns = cljs.core.nth.call(null,vec__31417,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__31417,(1),null);
return ((function (vec__31417,ns,vars__$1){
return (function (){
...
var G__31420 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__31420,G__31420__$1,env,once_fixtures,each_fixtures,vec__31417,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__31420,G__31420__$1,env,once_fixtures,each_fixtures,vec__31417,ns,vars__$1){
return (function (){
var seq__31421 = cljs.core.seq.call(null,vars__$1);
var chunk__31422 = null;
var count__31423 = (0);
var i__31424 = (0);
while(true){
if((i__31424 < count__31423)){
var v = cljs.core._nth.call(null,chunk__31422,i__31424);
var temp__5720__auto___31426 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___31426)){
var t_31427 = temp__5720__auto___31426;
each_fixture_fn.call(null,((function (seq__31421,chunk__31422,count__31423,i__31424,t_31427,temp__5720__auto___31426,v,each_fixture_fn,G__31420,G__31420__$1,env,once_fixtures,each_fixtures,vec__31417,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_31427)));
});})(seq__31421,chunk__31422,count__31423,i__31424,t_31427,temp__5720__auto___31426,v,each_fixture_fn,G__31420,G__31420__$1,env,once_fixtures,each_fixtures,vec__31417,ns,vars__$1))
);
} else {
}
...
var temp__5720__auto__ = cljs.core.seq.call(null,seq__31421);
if(temp__5720__auto__){
var seq__31421__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__31421__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__31421__$1);
var G__31432 = cljs.core.chunk_rest.call(null,seq__31421__$1);
var G__31433 = c__4550__auto__;
var G__31434 = cljs.core.count.call(null,c__4550__auto__);
var G__31435 = (0);
seq__31421 = G__31432;
...
var v = cljs.core.first.call(null,seq__31421__$1);
var temp__5720__auto___31436__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___31436__$1)){
var t_31437 = temp__5720__auto___31436__$1;
each_fixture_fn.call(null,((function (seq__31421,chunk__31422,count__31423,i__31424,t_31437,temp__5720__auto___31436__$1,v,seq__31421__$1,temp__5720__auto__,each_fixture_fn,G__31420,G__31420__$1,env,once_fixtures,each_fixtures,vec__31417,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_31437)));
});})(seq__31421,chunk__31422,count__31423,i__31424,t_31437,temp__5720__auto___31436__$1,v,seq__31421__$1,temp__5720__auto__,each_fixture_fn,G__31420,G__31420__$1,env,once_fixtures,each_fixtures,vec__31417,ns,vars__$1))
);
} else {
}


var G__31438 = cljs.core.next.call(null,seq__31421__$1);
var G__31439 = null;
var G__31440 = (0);
var G__31441 = (0);
seq__31421 = G__31438;
chunk__31422 = G__31439;
count__31423 = G__31440;
i__31424 = G__31441;
continue;
}
} else {
...
});})(each_fixture_fn,G__31420,G__31420__$1,env,once_fixtures,each_fixtures,vec__31417,ns,vars__$1))
);
});})(each_fixture_fn,G__31420,G__31420__$1,env,once_fixtures,each_fixtures,vec__31417,ns,vars__$1))
], null);
